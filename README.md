...
about experimental studies by reading the content in Section 4.1, with a focus
on the concepts behind a doubling experiment. Please note that this assignment
will also require you to read and uses Java classes that contain a test suite.
...
Guide](https://google.github.io/styleguide/javaguide.html). The final version of
this assignment should also meet all of the baseline requirements as explained
in the listing of automated
[GatorGrader](https://github.com/GatorEducator/gatorgrader) checks.
...
```
        ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
        ┃ Passed 58/58 (100%) of checks for cs101-F2019-lab5! ┃
        ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
```
...
```
git remote add download git@github.com:Allegheny-Computer-Science-101-F2019/cs101-F2019-lab5-starter.git
```
...
5](https://github.com/Allegheny-Computer-Science-101-F2019/cs101-F2019-lab5-starter)
repository and [raise an
issue](https://github.com/Allegheny-Computer-Science-101-F2019/cs101-F2019-lab5-starter/issues).
